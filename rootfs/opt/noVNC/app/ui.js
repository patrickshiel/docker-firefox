...
const UI = {
    ...
    start() {
        ...
        // Hack_Anchor
        // document.getElementById("noVNC_control_bar").style.display = "none";
        // document.getElementById("noVNC_control_bar_handle").style.display = "none";
        // document.getElementById("noVNC_control_bar_anchor").style.display = "none";

        // document.getElementById("noVNC_clipboard_text").style.display = "none";
        // document.getElementById("noVNC_clipboard_clear_button").style.display = "none";
 ...
 * ------v------*/
    ...
    clipboardReceive(e) {
        ...
        document.getElementById('noVNC_clipboard_text').value = e.detail.text.substr(0, 10);
    ...
    clipboardSend() {
        ...
        Log.Debug(">> UI.clipboardSend: " + text.substr(0, 10) + "...");
        UI.rfb.clipboardPasteFrom(text.substr(0, 10));
